...
- تنظیم جداگانهٔ آواتار کارت با Custom Emoji؛ شناسهٔ ایموجی در D1 ذخیره می‌شود و پیام ایموجی در حالت تنظیم به‌عنوان پست پردازش نمی‌شود
- تنظیم مستقل Custom Emoji لوگوهای X، Instagram و Telegram با جایگزین استاندارد تا پیش از تنظیم
