...
ربات خصوصی تلگرامِ بهرام قربانی، روی Cloudflare Workers و D1. پیام متنی یا پست فورواردی را به پیش‌نویس قابل‌تأیید تبدیل می‌کند، ارجاعات کانال مبدأ را پاک می‌کند، ایموجی‌های فناوری/آتش/راکت به ابتدای پاراگراف‌ها می‌افزاید و امضا را به‌صورت Native Rich Message نمایش می‌دهد.
...
- تنظیم جداگانهٔ آواتار کارت با Custom Emoji یا ایموجی استاندارد؛ مقدار آیکون در D1 ذخیره می‌شود و پیام آن در حالت تنظیم به‌عنوان پست پردازش نمی‌شود
- تنظیم مستقل آیکون‌های آواتار، X، Instagram و Telegram با پشتیبانی از Custom Emoji یا ایموجی استاندارد رایگان
- کارت Native امضا با عنوان `Join the Bahram Community`، قاب bordered و لینک‌های X، Telegram، Instagram و PayKaar
- انتشار متن و رسانه در یک Rich Message واحد با سقف ۳۲٬۷۶۸ کاراکتر متن
